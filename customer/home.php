...
<?php include('mobile_menu.php'); ?>
            <!-- Mobile Menu end -->
			 ...
			 <div class="single-pro-review-area mt-t-35 mg-b-20">
            <div class="container-fluid">
                <div class="row">
              <div class="col-lg-10 col-md-10 col-sm-10 col-xs-18">
					 ...
					 <!-- <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="profile-info-inner">
                            <div class="profile-img">
                                <img src="img/profile/2.jpg" class="img-circle circle-border m-b-md" alt="profile" />
                            </div>
                            <div class="profile-details-hr">
                                <div class="row">
                                   
                                        <div class="address-hr">
                                            <h2>Dr. RENUKA SALUNKE</h2>
                                    <p>Professor & Chief Warden</p>	
                                        </div>
					 ...
					 <!-- <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="profile-info-inner">
                            <div class="profile-img">
								...
								<img src="../../images/warden/Dr Renuka Budihal.jpg" class="img-circle circle-border m-b-md" alt="profile">
                            </div>
                            <div class="profile-details-hr">
                                <div class="row">
