        ...
        <nav id="sidebar" class="">
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
					...
					<li>
                            <a title="Home" href="home.php" <?php if($active=='home') { ?> class="active" <?php }?>  aria-expanded="false">
							<span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> 
							<span class="mini-click-non">Home</span></a>
                        </li>
						
						<li>
                            <a title="My Profile" href="customer_view.php" <?php if($active=='customer_edit') { ?> class="active" <?php }?> aria-expanded="false">
							<span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> 
							
							<span class="mini-click-non"> My Profile</span></a>
                        </li>
						
						<li>
                            <a title="My Vehical" href="car_details_view.php" <?php if($active=='car_details_view') { ?> class="active" <?php }?>  >
							<span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span>
							 <span class="mini-click-non">My Vehical Detatils</span></a>
                        </li>
						
						<li>
                            <a title="Booking Details"href="booking_view.php" <?php if($active=='booking_view') { ?> class="active" <?php }?> aria-expanded="false">
							<span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> 
							<span class="mini-click-non">Book My Server</span></a>
                        </li>
						
						<li>
                            <a title=" Bill Details"href="billing_details_view.php" <?php if($active=='billing_details_view') { ?> class="active" <?php }?> aria-expanded="false">
							<span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true">
							</span> <span class="mini-click-non">MY BILLING</span></a>
                        </li>
						
						<!-- <li>
                            <a title="Landing Page" href="notification.php" aria-expanded="false">
							
							<span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> 
							<span class="mini-click-non">Notifications</span></a>
                        </li>
						
						<li>
                            <a title="Landing Page" href="#" aria-expanded="false">
							<span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span>
							 <span class="mini-click-non">Hostel Help</span></a>
                        </li> -->
