...
<section class="main">
	<div class="layer">
		...
		<div class="bottom-grid">
			<div class="logo">
				<h1> <a href=""><span class=""></span></a></h1>
			</div>

		</div>
		<div class="content-w3ls">
			<li>
						<a href="" class=""><center><h1>Enter Your Ans</h1></center></a>
					</li>
				...
				<form action="getpwd.php" method="post">
					...
					<div class="field-group">
						...
						<div class="wthree-field">
							<input name="username" id="text1" type="text" value="<?php echo " ".$hintqtn; ?>" readonly="">
					...
					<div class="field-group">
						<span class="fa fa-user" aria-hidden="true"></span>
						<div class="wthree-field">
							<input name="hintans1" id="text1" type="text" value="" placeholder="Username" required>
						</div>
					</div>
