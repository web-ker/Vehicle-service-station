...
<body>
    ...
    <tr>
      ...
      <td>&nbsp;<a href="employee_edit.php?employee_id=<?php echo $row['employee_id'];?>"><img src="../IMAGES/edit.png"width="30" height="30"</a></a></td>
      <td>&nbsp;<a href="employee_delete.php?employee_id=<?php echo $row['employee_id'];?>"onclick="return confirm('do you want to delete?')"><img src="../IMAGES/delete.png"width="30" height="30"</a></a></td>
    </tr>
	<?php 
	}
	?>
