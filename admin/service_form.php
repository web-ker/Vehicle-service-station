...
<form name="formID" id="formID" method="post" action="service_insert.php">
  <table width="362" height="330" border="0" align="center">
    ...
    <tr>
      <td>Description</td>
      <td><textarea name="service_description" class=" form-control validate,[required]" id="service_description"></textarea></td>
    </tr>
    <tr>
