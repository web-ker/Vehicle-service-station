        ...
        <nav id="sidebar" class="">
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
					...
					<li>
                            <a title="Home" <?php if($active=='home') { ?> class="active" <?php }?> href="home.php"  aria-expanded="false">
							<span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> 
							<span class="mini-click-non">Home</span></a>
                        </li>
						
						<li>
                            <a title="Booking "href="booking_view.php" <?php if($active=='booking_view') { ?> class="active" <?php }?> aria-expanded="false">
							<span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> 
							
							<span class="mini-click-non"> BOOKING  </span></a>
                        </li>
						
						<li>
                            <a title="CUSTOMER DETAILS"href="customer_view.php" <?php if($active=='customer_view') { ?> class="active" <?php }?> >
							<span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span>
							 <span class="mini-click-non">CUSTOMER </span></a>
                        </li>
						
						<li>
                            <a title="Vehicle Details" href="car_details_view.php" <?php if($active=='car_details_view') { ?> class="active" <?php }?>aria-expanded="false">
							<span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> 
							<span class="mini-click-non">Vehicle </span></a>
                        </li>
						
						<li>
                            <a title="SERVICE DETAILS" href="service_view.php" <?php if($active=='service_view') { ?> class="active" <?php }?> aria-expanded="false">
							<span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true">
							</span> <span class="mini-click-non">SERVICE </span></a>
                        </li>
						
						<li>
                            <a title="EMPLOYEE DETAILS" href="employee_view.php" <?php if($active=='employee_view') { ?> class="active" <?php }?>aria-expanded="false">
						...
						<li>
                            <a title="JOBCARD DETAILS" href="jobcard_details_view.php" <?php if($active=='jobcard_details_view') { ?> class="active" <?php }?> aria-expanded="false">
							<span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span>
							 <span class="mini-click-non">JOBCARD </span></a>
                        </li>
						
						<li>
                            <a title="JOBCARD DETAILS" href="jobcard_details_view.php" <?php if($active=='jobcard_details_view') { ?> class="active" <?php }?> aria-expanded="false">
							<span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span>
							 <span class="mini-click-non">JOBDONE </span></a>
                        </li>
                        
						<li>
                            <a title="JOBCARD DETAILS" href="spare_details_view.php" <?php if($active=='spare_details_view') { ?> class="active" <?php }?> aria-expanded="false">
							<span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span>
							 <span class="mini-click-non">SPARE </span></a>
                        </li>
						
						<li>
                            <a title="SPARE DELIVERY DETAILS" href="spare_delivery_form.php" <?php if($active=='spare_delivery_form') { ?> class="active" <?php }?> aria-expanded="false">
							<span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span>
							 <span class="mini-click-non">SPARE DELIVERY </span></a>
                        </li>
						
						<li>
                            <a title="CUSTOMER BILLING DETAILS" href="billing_details_view.php" <?php if($active=='billing_details_view') { ?> class="active" <?php }?> aria-expanded="false">
							<span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span>
							 <span class="mini-click-non">CUSTOMER BILLING </span></a>
                        </li>
