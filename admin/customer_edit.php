...
<input type="hidden"  name="customer_id"  value="<?php echo $row['customer_id'];?>">
  <table width="410" height="246" border="0">
    <tr>
    ...
    <tr>
      <td>Email</td>
      <td><input name="customer_email" type="text" id="customer_email" class="form-control validate,[required,custom[email]]" value="<?php echo $row['customer_email'];?>"></td>
    </tr>
    <tr>
