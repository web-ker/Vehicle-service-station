...
<body>
    ...
    <tr>
      ...
      <td>&nbsp;<a href="spare_delivery_edit.php?spare_delivery_id=<?php echo $row['spare_delivery_id'];?>">edit</a></td>
      <td>&nbsp;<a href="spare_delivery_delete.php?spare_delivery_id=<?php echo $row['spare_delivery_id'];?>">delete</a></td>
    </tr>
	<?php 
	}
	?>
