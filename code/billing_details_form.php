...
<form name="formID" id="formID" method="post" action="billing_details_insert.php">
  <table width="395" height="410" border="0">
    ...
    <tr>
	  ...
	  {
	  ?>
	  <option value="<?php echo $row3['jobcard_id'];?>"><?php echo $row3['jobcard_date'];?></option>
	  <?php
	  }
	  ?>
	  	 </select></td>
    ...
    <tr>
      <td>Service Date </td>
      <td><input name="service_date" type="date" id="service_date" class="form-control  validate,[required]"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td>cgst</td>
      <td><input name="cgst" type="text" id="cgst"  class="form-control  validate,[required,custom[onlyNumber]]"></td>
    </tr>
    <tr>
      <td>sgst</td>
      <td><input name="sgst" type="text" id="sgst" class="form-control  validate,[required,custom[onlyNumber]]"></td>
    </tr>
    <tr>
