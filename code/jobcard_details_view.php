...
<body>
    ...
    <tr>
      ...
      <td>&nbsp;<a href="jobcard_details_edit.php?jobcard_id=<?php echo $row['jobcard_id'];?>">edit</a></td>
      <td>&nbsp;<a href="jobcard_details_delete.php?jobcard_id=<?php echo $row['jobcard_id'];?>">delete</a></td>
    </tr>
	<?php 
	}
	?>
