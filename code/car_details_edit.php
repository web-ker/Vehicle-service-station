 ...
 ?>
  ...
  ?>
    ...
    <tr>
      ...
      <td><input name="car_make" type="text" id="car_make"  class=" form-control validate,[required,custom[onlyLetter]]" value="<?php echo $row['car_make'];?>"></td>
    </tr>
    <tr>
      <td>Car Model </td>
    ...
    <tr>
      <td>Car RegNO </td>
      <td><input name="car_regno" type="text" id="car_regno" class=" form-control validate,[required,custom[onlyNumber]]" value="<?php echo $row['car_regno'];?>"></td>
    </tr>
    <tr>
